...
sat.create_image(color_array, path=proyect_path + '\\images', name='Color', extension='tiff')

colorGeo1_array = sat.latlon(color_array, file=file_path, way=1, interpolation=True)
sat.create_image(colorGeo1_array, path=proyect_path + '\\images', name='ColorGeo Bilinter', extension='tiff')

colorGeo2_array = sat.latlon(color_array, file=file_path, way=1, interpolation=False)
sat.create_image(colorGeo2_array, path=proyect_path + '\\images', name='ColorGeo', extension='tiff')

colorGeo3_array = sat.latlon(color_array, file=file_path, way=2)
sat.create_image(colorGeo3_array, path=proyect_path + '\\images', name='ColorGeo Modo 2', extension='tiff')
